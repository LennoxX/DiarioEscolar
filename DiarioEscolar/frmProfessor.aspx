<%@ Page Title="Professores" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmProfessor.aspx.vb" Inherits="DiarioEscolar.frmProfessor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Formulário de Professores</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
             <div class="card card-outline card-info card-default">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <label>Email:</label>
                            <asp:TextBox runat="server" CssClass="form-control" required="required" type="email" ID="txtEmail" name="Email" placeholder="Ex.: joao@mail.com" MaxLength="250" />
            ...
            <div class="card card-outline card-info mt-5">
                <div class="card-body">
                   ...
                   <asp:GridView ID="grdProfessor" runat="server" CssClass="table table-bordered" PagerStyle-HorizontalAlign="Right" AllowPaging="True" PageSize="2" AutoGenerateColumns="False" DataKeyNames="EE02_ID_PROFESSOR" AllowSorting="True">
                        <HeaderStyle CssClass="bg-white" ForeColor="Black" />
                        <Columns>
                            <asp:BoundField DataField="EE02_ID_PROFESSOR" SortExpression="EE02_ID_PROFESSOR" HeaderText="Código" />
                            <asp:BoundField DataField="EE02_NM_NOME" SortExpression="EE03_NM_NOME" HeaderText="Nome" />
                            <asp:BoundField DataField="EE02_NR_MATRICULA" SortExpression="EE03_DS_MATRICULA" HeaderText="Matrícula" />
                            <asp:TemplateField HeaderText="" SortExpression="" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkEditarProfessor" runat="server" class="btn btn-md btn-info" CommandName="EDITAR" ToolTip="Editar Professor">
                                            <i runat="server" class="fa fa-pencil-alt"></i>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="lnkExcluirProfessor" runat="server" class="btn btn-md btn-danger" CommandName="EXCLUIR" ToolTip="Excluir AlProfessoruno">
